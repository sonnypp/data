        ...
        <div class="inner-cont0">
            <div class="inner-cont1 w1200">
                <div class="inner-cont2">
                    ...
                    <a href=<?php echo U('/info');?>  class="active">零食资讯</a>
    ...
    <div class="info-list-box">
        <div class="info-list w1200">
            <div class="item-box layui-clear" id="list-cont">
                <?php if(!$information): ?><h1 style="align-content: center">管理员未发布任何资讯</h1><?php endif; ?>
                <else >
                    <?php if(is_array($information)): foreach($information as $key=>$vo): ?><div class="item">
                            <div class="img">
                                <img src="/api/Public/<?php echo ($vo["information_pic"]); ?>" alt=""  width="280px" height="280px" style="margin: 3px; border: black 2px">
                            </div>
                            <div class="text">

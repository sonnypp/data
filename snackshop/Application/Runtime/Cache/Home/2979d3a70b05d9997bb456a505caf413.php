...
<div class="content content-nav-base buytoday-content">
    <div id="list-cont">
        ...
        <div class="banner-box">
            <div class="banner" style='background: url("/api/Public/<?php echo ($t_banner); ?>") no-repeat;background-size: cover;'></div>
        </div>
            ...
            <div class="product-list w1200">
                ...
                <div class="list-cont" cont = 'newtuijian'>
                    <div class="item-box layui-clear">
                        <?php if(is_array($g_new)): foreach($g_new as $key=>$vo): ?><div class="item">
                                <img src="/api/Public/<?php echo ($vo["goods_pic"]); ?>" alt="" width="270px" height="300px" style="margin: 3px; border: black 2px">
                                <div class="text-box">
                                    <p class="title"><?php echo ($vo["goods_name"]); ?></p>
                                    <p class="plic">
                                        <span class="ciur-pic">￥<?php echo ($vo["goods_shichangjia"]); ?></span>
                                        <span class="discount"><a href="<?php echo U('/details',array(goods_id=>$vo['goods_id']));?>">详情</a></span>
                                    </p>
                                </div>
                ...
                <div class="list-cont layui-hide" cont = 'rexiaotuijian'>
                    <div class="item-box layui-clear">
                        <?php if(is_array($g_rexiao)): foreach($g_rexiao as $key=>$vo): ?><div class="item">
                                <img src="/api/Public/<?php echo ($vo["goods_pic"]); ?>" alt="" width="270px" height="320px" style="margin: 3px; border: black 2px">
                                <div class="text-box">
                                    <p class="title"><?php echo ($vo["goods_name"]); ?></p>
                                    <p class="plic">
                                        <span class="ciur-pic">￥<?php echo ($vo["goods_shichangjia"]); ?></span>

...
<div class="content">
    ...
    <div class="category-con">
        ...
        <div class="category-banner">
            <div class="w1200">
                <img src="/api/Public/res/static/img/banner3.jpg">
            </div>
        </div>
    </div>
    <div class="floors">
    ...
    <div class="product-cont w1200" id="product-cont">
        <div class="product-item product-item1 layui-clear">
            ...
            <div class="right-cont">
                <a href="javascript:;" class="top-img"><img src="/api/Public/res/static/img/img13.jpg" alt=""></a>
                <div class="img-box">
        ...
        <div class="product-item product-item2 layui-clear">
            ...
            <div class="right-cont">
                <a href="javascript:;" class="top-img"><img src="/api/Public/res/static/img/img14.jpg" alt=""></a>
                <div class="img-box">

                            ...
                            <form class="layui-form" lay-filter="formAddFilter">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="liuyan_title" placeholder="标题" autocomplete="off" class="layui-input" required>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">留言内容</label>
                                    <div class="layui-input-block">
                                        <textarea type="text" name="liuyan_content" id="LAY_content" lay-verify="liuyan_content" class="field-liuyan_content" required></textarea>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
...
<script>
    ...
    }).use(['mm','laypage','jquery','layedit','form'],function(){
